...
const project2 = new Project(
  ...
  En este proyecto, me enfoqué principalmente en el desarrollo frontend, diseñando diversas vistas
   y trabajando en la lógica de la interfaz de usuario. Sin embargo, también contribuí al desarrollo backend,
    implementando funcionalidades adicionales como el envío de correos electrónicos y otras tareas.`,
